...
CONFIG = {
    ...
    'in_channels': 102,      # 102 for PaviaC, 103 for PaviaU
...
# %%
# =============================================================================
# CELL 10: RESUME ×3 TRAINING (PaviaC — continue from epoch 10 to 30)
# =============================================================================
print("🚀 Training pipeline: resume ×3 → ×4 (PaviaC)")
print(f"   Dataset: {CONFIG['dataset_name']} | Data: {CONFIG['data_dir']}")

ckpt_x3_resume = '/kaggle/input/datasets/vujjapunithsai/btpcheckpoint-paviac/srmamba_t_x3_best.pth'
ckpt_x3 = train_scale(
    scale=3,
    config=CONFIG,
    prev_checkpoint_path=None,
    resume_checkpoint_path=ckpt_x3_resume
)


# %%
# =============================================================================
# CELL 11: SKIP ×2 (PaviaC ×2 at 10 epochs is acceptable — 21.05 dB)
# =============================================================================
ckpt_x2 = '/kaggle/input/datasets/vujjapunithsai/btpcheckpoint-paviac/srmamba_t_x2_best.pth'
print(f"\n  ✅ ×2: Skipping (10 epochs, PSNR 21.05 dB — acceptable)")


# %%
# =============================================================================
# CELL 12: RESUME ×4 TRAINING (PaviaC — continue from epoch 10 to 30)
# =============================================================================
ckpt_x4_resume = '/kaggle/input/datasets/vujjapunithsai/btpcheckpoint-paviac/srmamba_t_x4_best.pth'
ckpt_x4 = train_scale(
    scale=4,
    config=CONFIG,
